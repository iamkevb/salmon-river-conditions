...
func fetchData(lat float64, lon float64) []byte {
	var apiURL = fmt.Sprintf("https://api.open-meteo.com/v1/forecast?latitude=%f&longitude=%f&hourly=pressure_msl&daily=temperature_2m_max,temperature_2m_min,rain_sum,snowfall_sum&timezone=America%%2FNew_York&past_days=5&forecast_days=3", lat, lon)
